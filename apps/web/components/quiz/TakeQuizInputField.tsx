...
export default function TakeQuizInputField(
  {
    ...
    formikProps,
    answer,
  }: { type: string; formikProps: FormikProps<Submit_Quiz>; answer: Answer }
  ...
  return (
    <div className="flex items-center justify-normal pl-4 sm:pl-6">
      <label
        ...
        htmlFor={`custom-checkbox-${answer.id}`}
      >
        <Field
          type={type}
          name={`checkbox-group-${answer.qnaID}`}
          ...
          id={`custom-checkbox-${answer.id}`}
        />
        <ErrorMessage name={`checkbox-group-${answer.qnaID}`} component="div" />
